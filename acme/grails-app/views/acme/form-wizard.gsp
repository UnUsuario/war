...
<!-- Mirrored from bootstrapmaster.com/live/acme2/form-wizard by HTTrack Website Copier/3.x [XR&CO'2013], Tue, 20 Sep 2016 15:40:39 GMT -->
<head>
				...
				<div class="nav-no-collapse header-nav">
					<ul class="nav pull-right">
						<li class="dropdown hidden-xs">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="form-wizard">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="form-wizard"><i class="halflings user white"></i> Profile</a></li>
			...
			<div id="sidebar-left" class="col-sm-1">
				<div class="nav-collapse sidebar-nav collapse navbar-collapse bs-navbar-collapse">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							<a class="dropmenu" href="form-wizard"><i class="fa fa-edit"></i><span class="hidden-sm"> Forms</span> <span class="badge badge-info">3</span></a>
							<ul>
				...
				<div class="col-lg-12">
					<div class="box">
						<div class="box-header">
							...
							<div class="box-icon">
								<a href="form-wizard" class="btn-setting"><i class="fa fa-wrench"></i></a>
								<a href="form-wizard" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
								<a href="form-wizard" class="btn-close"><i class="fa fa-times"></i></a>
							</div>
						</div>
						<div class="box-content">
							<div id="MyWizard" class="wizard">
								...
								<div class="actions">
									...
									<button type="button" class="btn btn-success btn-next" data-last="Finish">Next <i class="fa fa-arrow-right"></i></button>
								</div>
							</div>
...
<div id="widgets-area" class="col-sm-2">
	...
	<ul class="nav tab-menu nav-tabs" id="myTab">
		...
		<li><a id="close-widgets-area" href="form-wizard"><i class="fa fa-sign-in"></i></a></li>
	</ul>
	...
	<div id="myTabContent" class="tab-content">
		...
		<div class="tab-pane" id="users">
			...
			<ul class="users-list">
				...
				<li>
            		<a href="form-wizard">View all users</a>
				</li>	
			</ul>
		...
		<div class="tab-pane" id="messages">
			...
			<ul class="messages-list">
				...
				<li>
            		<a href="form-wizard">View all messages</a>
				</li>	
			</ul>
...
<a id="widgets-area-button" class="hidden-sm hidden-xs open"><i class="fa fa-bars"></i></a>				
	...
	<asset:javascript src="wizard.min.js"/>
	...
	<asset:javascript src="pages/form-wizard.js"/>
	
	<!-- end: JavaScript-->
	
</body>

<!-- Mirrored from bootstrapmaster.com/live/acme2/form-wizard by HTTrack Website Copier/3.x [XR&CO'2013], Tue, 20 Sep 2016 15:40:40 GMT -->
</html>