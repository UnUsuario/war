...
<!-- Mirrored from bootstrapmaster.com/live/acme2/login by HTTrack Website Copier/3.x [XR&CO'2013], Tue, 20 Sep 2016 15:42:08 GMT -->
<head>
	...
	<!-- end: Favicon and Touch Icons -->
			...
			<style type="text/css">body { background: url("assets/bg-login.jpg") !important; }
		</style>
			...
			<div class="row">
				<div class="login-box">
					<div class="icons">
						...
						<a href="login"><i class="halflings-icon cog"></i></a>
					</div>
					<h2>Login to your account</h2>
					<form class="form-horizontal" action="http://bootstrapmaster.com/live/acme2/index" method="post">
						<fieldset>
					...
					<p>
						No problem, <a href="login">click here</a> to get a new password.
					</p>	
				</div><!--/col-->
			</div><!--/row-->
