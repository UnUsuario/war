...
<!-- Mirrored from bootstrapmaster.com/live/acme2/widgets by HTTrack Website Copier/3.x [XR&CO'2013], Tue, 20 Sep 2016 15:40:28 GMT -->
<head>
				...
				<div class="nav-no-collapse header-nav">
					<ul class="nav pull-right">
						<li class="dropdown hidden-xs">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="widgets">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="widgets"><i class="halflings user white"></i> Profile</a></li>
						...
						<div class="col-sm-6">
							<div class="box">
								<div class="box-header">
									...
									<div class="box-icon">
										<a href="widgets" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
										<a href="widgets" class="btn-close"><i class="fa fa-times"></i></a>
									</div>
								</div>
							...
							<div class="box">
								...
								<div class="box-content">
									<ul class="dashboard-list">
										<li>
											<a href="widgets">
												<asset:image class="avatar" alt="Lucas" src="avatar.jpg"/>
											</a>
											<strong>Name:</strong> <a href="widgets">Łukasz Holeczek</a><br>
											<strong>Since:</strong> Jul 25, 2012 11:09<br>
											<strong>Status:</strong> <span class="label label-success">Approved</span>                                  
										</li>
										<li>
											<a href="widgets">
												<asset:image class="avatar" alt="Bill" src="avatar9.jpg"/>
											</a>
											<strong>Name:</strong> <a href="widgets">Bill Cole</a><br>
											<strong>Since:</strong> Jul 25, 2012 11:09<br>
											<strong>Status:</strong> <span class="label label-warning">Pending</span>                                 
										</li>
										<li>
											<a href="widgets">
												<asset:image class="avatar" alt="Jane" src="avatar5.jpg"/>
											</a>
											<strong>Name:</strong> <a href="widgets">Jane Sanchez</a><br>
											<strong>Since:</strong> Jul 25, 2012 11:09<br>
											<strong>Status:</strong> <span class="label label-important">Banned</span>                                  
										</li>
										<li>
											<a href="widgets">
												<asset:image class="avatar" alt="Kate" src="avatar6.jpg"/>
											</a>
											<strong>Name:</strong> <a href="widgets">Kate Presley</a><br>
											<strong>Since:</strong> Jul 25, 2012 11:09<br>
				...
				<div class="col-md-4 col-sm-12">
					<div class="box">
						<div class="box-header">
							...
							<div class="box-icon">
								<a href="widgets" class="btn-setting"><i class="fa fa-wrench"></i></a>
								<a href="widgets" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
								<a href="widgets" class="btn-close"><i class="fa fa-times"></i></a>
							</div>
						</div>
									...
									<li>
										Windows Phone 8 App <span class="label label-important">today</span>
															<span class="todo-actions">
																<a href="widgets"><i class="fa fa-check"></i></a>
																<a href="widgets" class="todo-remove"><i class="fa fa-times"></i></a>
															</span>
									</li>
							...
							<ul class="tickets">
								<li class="ticket">
									<a href="widgets">
										...
										<span class="content">
											<span class="avatar"><asset:image src="avatar6.jpg" alt="Avatar"/></span>
							  	...
							  	<li class="ticket">
									<a href="widgets">
										...
										<span class="content">
											<span class="avatar"><asset:image src="avatar7.jpg" alt="Avatar"/></span>
								...
								<li class="ticket">
									<a href="widgets">
										...
										<span class="content">
											<span class="avatar"><asset:image src="avatar8.jpg" alt="Avatar"/></span>
								...
								<li class="ticket">
									<a href="widgets">
										...
										<span class="content">
											<span class="avatar"><asset:image src="avatar9.jpg" alt="Avatar"/></span>
...
<a id="widgets-area-button" class="hidden-sm hidden-xs open"><i class="fa fa-bars"></i></a>				
	...
	<asset:javascript src="pages/widgets.js"/>
	
	<!-- end: JavaScript-->
	
</body>

<!-- Mirrored from bootstrapmaster.com/live/acme2/widgets by HTTrack Website Copier/3.x [XR&CO'2013], Tue, 20 Sep 2016 15:40:31 GMT -->
</html>