...
<!-- Mirrored from bootstrapmaster.com/live/acme2/icons-font-awesome by HTTrack Website Copier/3.x [XR&CO'2013], Tue, 20 Sep 2016 15:41:31 GMT -->
<head>
				...
				<div class="nav-no-collapse header-nav">
					<ul class="nav pull-right">
						<li class="dropdown hidden-xs">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="icons-font-awesome">
						...
						<li>
							<a class="btn" href="icons-font-awesome">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="icons-font-awesome"><i class="halflings user white"></i> Profile</a></li>
			...
			<div id="sidebar-left" class="col-sm-1">
				<div class="nav-collapse sidebar-nav collapse navbar-collapse bs-navbar-collapse">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							<a class="dropmenu" href="icons-font-awesome"><i class="fa fa-star"></i><span class="hidden-sm"> Icons</span> <span class="badge">3</span></a>
							<ul>
			...
			<div class="col-xs-12">
				<div class="box">
				  <div class="box-header">
				    <h2><i class=" fa fa-asterisk"></i> Web Application Icons</h2>
				  </div>
				...
				<div class="box">
				  <div class="box-header">
				    <h2><i class="fa fa-check-square"></i> Form Control Icons</h2>
				  </div>
				  <div class="box-content">
				    <div class="row fontawesome-icon-list">
				...
				<div class="box">
				  <div class="box-header">
				    <h2><i class="fa fa-usd"></i> Currency Icons</h2>
				  </div>
				  <div class="box-content">
				    <div class="row fontawesome-icon-list">
				...
				<div class="box">
				  <div class="box-header">
				    <h2><i class="fa fa-file-text-o"></i> Text Editor Icons</h2>
				  </div>
				  <div class="box-content">
				    <div class="row fontawesome-icon-list">
				...
				<div class="box">
				  <div class="box-header">
				    <h2><i class="fa fa-arrow-right"></i> Directional Icons</h2>
				  </div>
				  <div class="box-content">
				    <div class="row fontawesome-icon-list">
				...
				<div class="box">
				  <div class="box-header">
				    <h2><i class="fa fa-eject"></i> Video Player Icons</h2>
				  </div>
				  <div class="box-content">
				    <div class="row fontawesome-icon-list">
				...
				<div class="box">
				  <div class="box-header">
				    <h2><i class="fa fa-linux"></i> Brand Icons</h2>
				  </div>
				  <div class="box-content">
				    <div class="row fontawesome-icon-list">
				...
				<div class="box">
				  <div class="box-header">
				    <h2><i class="fa fa-ambulance"></i> Medical Icons</h2>
				  </div>
				  <div class="box-content">
				    <div class="row fontawesome-icon-list">
...
<div id="widgets-area" class="col-sm-2">
	...
	<ul class="nav tab-menu nav-tabs" id="myTab">
		...
		<li><a id="close-widgets-area" href="icons-font-awesome"><i class="fa fa-sign-in"></i></a></li>
	</ul>
	...
	<div id="myTabContent" class="tab-content">
		...
		<div class="tab-pane" id="users">
			...
			<ul class="users-list">
				...
				<li>
            		<a href="icons-font-awesome">View all users</a>
				</li>	
			</ul>
		...
		<div class="tab-pane" id="messages">
			...
			<ul class="messages-list">
				...
				<li>
            		<a href="icons-font-awesome">View all messages</a>
				</li>	
			</ul>
