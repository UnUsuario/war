...
<!-- Mirrored from bootstrapmaster.com/live/acme2/page-inbox by HTTrack Website Copier/3.x [XR&CO'2013], Tue, 20 Sep 2016 15:40:33 GMT -->
<head>
				...
				<div class="nav-no-collapse header-nav">
					<ul class="nav pull-right">
						<li class="dropdown hidden-xs">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="page-inbox">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="page-inbox"><i class="halflings user white"></i> Profile</a></li>
			...
			<div id="sidebar-left" class="col-sm-1">
				<div class="nav-collapse sidebar-nav collapse navbar-collapse bs-navbar-collapse">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							<a class="dropmenu" href="page-inbox"><i class="fa fa-folder-o"></i><span class="hidden-sm"> Example Pages</span> <span class="badge badge-important">3</span></a>
							<ul>
					...
					<div class="message-view">
						...
						<div class="message">
							...
							<div class="header">
								...
								<div class="from"><i class="halflings user"></i> <b>Lukasz Holeczek</b> / lukasz@holeczek.pl</div>
								<div class="date"><i class="halflings time"></i> Today, <b>3:47 PM</b></div>
								...
								<ul>
									<li>
										...
										<span class="quickMenu">
											<a href="page-inbox" class="glyphicons search"><i></i></a>
											<a href="page-inbox" class="glyphicons share"><i></i></a>
											<a href="page-inbox" class="glyphicons cloud-download"><i></i></a>
										</span>
									</li>
									<li>
...
<div id="widgets-area" class="col-sm-2">
	...
	<ul class="nav tab-menu nav-tabs" id="myTab">
		...
		<li><a id="close-widgets-area" href="page-inbox"><i class="fa fa-sign-in"></i></a></li>
	</ul>
	...
	<div id="myTabContent" class="tab-content">
		...
		<div class="tab-pane" id="users">
			...
			<ul class="users-list">
				...
				<li>
            		<a href="page-inbox">View all users</a>
				</li>	
			</ul>
		...
		<div class="tab-pane" id="messages">
			...
			<ul class="messages-list">
				...
				<li>
            		<a href="page-inbox">View all messages</a>
				</li>	
			</ul>
...
<a id="widgets-area-button" class="hidden-sm hidden-xs open"><i class="fa fa-bars"></i></a>				
	...
	<asset:javascript src="pages/page-inbox.js"/>
	
	<!-- end: JavaScript-->
	
</body>

<!-- Mirrored from bootstrapmaster.com/live/acme2/page-inbox by HTTrack Website Copier/3.x [XR&CO'2013], Tue, 20 Sep 2016 15:40:34 GMT -->
</html>