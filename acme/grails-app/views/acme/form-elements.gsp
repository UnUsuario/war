...
<!-- Mirrored from bootstrapmaster.com/live/acme2/form-elements by HTTrack Website Copier/3.x [XR&CO'2013], Tue, 20 Sep 2016 15:40:34 GMT -->
<head>
				...
				<div class="nav-no-collapse header-nav">
					<ul class="nav pull-right">
						<li class="dropdown hidden-xs">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="form-elements">
						...
						<li>
							<a class="btn" href="form-elements">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="form-elements"><i class="halflings user white"></i> Profile</a></li>
		...
		<div class="row">
			...
			<div id="sidebar-left" class="col-sm-1">
				<div class="nav-collapse sidebar-nav collapse navbar-collapse bs-navbar-collapse">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							<a class="dropmenu" href="form-elements"><i class="fa fa-edit"></i><span class="hidden-sm"> Forms</span> <span class="badge badge-info">3</span></a>
							<ul>
				...
				<div class="col-lg-12">
					<div class="box">
						<div class="box-header">
							...
							<div class="box-icon">
								<a href="form-elements" class="btn-setting"><i class="fa fa-wrench"></i></a>
								<a href="form-elements" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
								<a href="form-elements" class="btn-close"><i class="fa fa-times"></i></a>
							</div>
						</div>
						<div class="box-content">
							<form role="form">	
								...
								<div class="form-group hidden-xs">
								  <label class="control-label" for="textarea2">Textarea with CLEditor</label>
								  <div class="controls">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="box">
						<div class="box-header">
							<h2><i class="fa fa-edit"></i>Form Elements with Masked Input</h2>
							<div class="box-icon">
								<a href="form-elements" class="btn-setting"><i class="fa fa-wrench"></i></a>
								<a href="form-elements" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
								<a href="form-elements" class="btn-close"><i class="fa fa-times"></i></a>
...
<div id="widgets-area" class="col-sm-2">
	...
	<ul class="nav tab-menu nav-tabs" id="myTab">
		...
		<li><a id="close-widgets-area" href="form-elements"><i class="fa fa-sign-in"></i></a></li>
	</ul>
	...
	<div id="myTabContent" class="tab-content">
		...
		<div class="tab-pane" id="users">
			...
			<ul class="users-list">
				...
				<li>
            		<a href="form-elements">View all users</a>
				</li>	
			</ul>
		...
		<div class="tab-pane" id="messages">
			...
			<ul class="messages-list">
				...
				<li>
            		<a href="form-elements">View all messages</a>
				</li>	
			</ul>
...
<a id="widgets-area-button" class="hidden-sm hidden-xs open"><i class="fa fa-bars"></i></a>				
	...
	<asset:javascript src="jquery.chosen.min.js"/>
	<asset:javascript src="jquery.cleditor.min.js"/>
	...
	<asset:javascript src="jquery.inputlimiter.1.3.1.min.js"/>
	<asset:javascript src="bootstrap-datepicker.min.js"/>
	<asset:javascript src="bootstrap-timepicker.min.js"/>
	<asset:javascript src="moment.min.js"/>
	<asset:javascript src="daterangepicker.min.js"/>
	<asset:javascript src="jquery.hotkeys.min.js"/>
	<asset:javascript src="bootstrap-wysiwyg.min.js"/>
	...
	<asset:javascript src="pages/form-elements.js"/>
	
	<!-- end: JavaScript-->
	
</body>

<!-- Mirrored from bootstrapmaster.com/live/acme2/form-elements by HTTrack Website Copier/3.x [XR&CO'2013], Tue, 20 Sep 2016 15:40:39 GMT -->
</html>