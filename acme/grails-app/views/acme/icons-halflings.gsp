...
<!-- Mirrored from bootstrapmaster.com/live/acme2/icons-halflings by HTTrack Website Copier/3.x [XR&CO'2013], Tue, 20 Sep 2016 15:41:30 GMT -->
<head>
				...
				<div class="nav-no-collapse header-nav">
					<ul class="nav pull-right">
						<li class="dropdown hidden-xs">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="icons-halflings">
						...
						<li>
							<a class="btn" href="icons-halflings">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="icons-halflings"><i class="halflings user white"></i> Profile</a></li>
			...
			<div id="sidebar-left" class="col-sm-1">
				<div class="nav-collapse sidebar-nav collapse navbar-collapse bs-navbar-collapse">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							<a class="dropmenu" href="icons-halflings"><i class="fa fa-star"></i><span class="hidden-sm"> Icons</span> <span class="badge">3</span></a>
							<ul>
			...
			<div class="row">
				...
				<div class="box">
					<div class="box-header">
						...
						<div class="box-icon">
							<a href="icons-halflings" class="btn-setting"><i class="fa fa-wrench"></i></a>
							<a href="icons-halflings" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
							<a href="icons-halflings" class="btn-close"><i class="fa fa-times"></i></a>
						</div>
					</div>
...
<div id="widgets-area" class="col-sm-2">
	...
	<ul class="nav tab-menu nav-tabs" id="myTab">
		...
		<li><a id="close-widgets-area" href="icons-halflings"><i class="fa fa-sign-in"></i></a></li>
	</ul>
	...
	<div id="myTabContent" class="tab-content">
		...
		<div class="tab-pane" id="users">
			...
			<ul class="users-list">
				...
				<li>
            		<a href="icons-halflings">View all users</a>
				</li>	
			</ul>
		...
		<div class="tab-pane" id="messages">
			...
			<ul class="messages-list">
				...
				<li>
            		<a href="icons-halflings">View all messages</a>
				</li>	
			</ul>
...
<!-- Mirrored from bootstrapmaster.com/live/acme2/icons-halflings by HTTrack Website Copier/3.x [XR&CO'2013], Tue, 20 Sep 2016 15:41:31 GMT -->
</html>