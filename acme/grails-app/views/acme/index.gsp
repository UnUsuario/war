...
<!-- Mirrored from bootstrapmaster.com/live/acme2/index by HTTrack Website Copier/3.x [XR&CO'2013], Tue, 20 Sep 2016 15:39:57 GMT -->
<head>
		...
		<div class="row">
			...
			<div class="row">
				...
				<div class="widget col-md-5 col-sm-12">
					...
					<h2><i class="glyphicons globe"></i> Demographics</h2>
			...
			<div class="row">
				...
				<div class="widget col-sm-6 overflow:hidden">
					<h2><span class="social facebook"><i></i></span>Facebook Fans</h2>
					<hr>
					<div class="content">
				...
				<div class="widget col-sm-6 overflow:hidden">
					<h2><span class="social twitter"><i></i></span>Twitter Followers</h2>
					<hr>
					<div class="content">
...
<a id="widgets-area-button" class="hidden-sm hidden-xs open"><i class="fa fa-bars"></i></a>				
	...
	<asset:javascript src="pages/index.js"/>
	
	<!-- end: JavaScript-->
	
</body>

<!-- Mirrored from bootstrapmaster.com/live/acme2/index by HTTrack Website Copier/3.x [XR&CO'2013], Tue, 20 Sep 2016 15:40:23 GMT -->
</html>